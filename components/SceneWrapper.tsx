...
// This helper component lives inside the wrapper and controls the camera
        ...
        PanResponder.create({
            ...
            onPanResponderMove: (evt, gestureState) => {
                if (gestureState.numberActiveTouches === 2) {
                    ...
                    if (startPinchDistance.current === 0) { startPinchDistance.current = currentPinchDistance; }
                    else {
    ...
    return (
        <View style={styles.container} onLayout={onLayout}>
            ...
            <View style={[styles.overlay, { top: insets.top, left: insets.left + 10 }]}>
                <Text style={styles.overlayText}>{dimensionsText}</Text>
